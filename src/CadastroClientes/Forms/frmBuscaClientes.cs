...
namespace CadastroClientes.Forms
{
    public partial class frmBuscaClientes : Form
    {
        ...
        private void grid_CellDoubleClick(object sender, DataGridViewCellEventArgs e) {
            ...
            frmCadClientes.txtTelefone1.Text = grid.Rows[grid.CurrentRow.Index].Cells[15].Value.ToString();
            frmCadClientes.txtTelefone2.Text = grid.Rows[grid.CurrentRow.Index].Cells[16].Value.ToString();
            frmCadClientes.txtCelular1.Text = grid.Rows[grid.CurrentRow.Index].Cells[17].Value.ToString();
            frmCadClientes.txtCelular2.Text = grid.Rows[grid.CurrentRow.Index].Cells[18].Value.ToString();
            frmCadClientes.lblDataRegistro.Text = grid.Rows[grid.CurrentRow.Index].Cells[19].Value.ToString();
            frmCadClientes.Show();
